...
**As of:** `2024, Friday, February 2nd at 11:20 pm PST)`

| ℹ️ Dataset type | 🔢️ Count | ❌️ Dataset Exclusions |
|---|---|---|
| **[🎵️ Audio](#C-Audio) datasets:** | `17` | (not including [1](https://github.com/seanpm2001/AI2001_Category-Audio/)) |
...
| **Overall total:** | `661` _dataset repositories_ | **As of:** `2024.02.02@23:20PST` |
|---|---|---|
...
#### SC: Information Processing Language
...
> **Note** _Not to be confused with PlPGSQL_
...
- **File version:** `200 (2024, Friday, February 2nd at 11:20 pm PST)`
- **Line count (including blank lines and compiler line):** `9,702`
- **Word count:** `52,296`
- **Character count (including spaces):** `380,753`
- **Character count (excluding spaces):** `336,340`
- **Size (in bytes):** `380,899`
...
<details><summary><p lang="en"><b>Version 167 (2023, Thursday, November 23rd at 07:28 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V167.md)

> **Note** _Fixing some bugs partially, and making a daily update. Continuing for a second consective day_

> Changes:

- [x] Updated the tags section
- - [x] Divided all lines up, so that no line is 1000 characters or longer (helps prevent lag and crashes)
- [x] Updated the `Dataset counters` section
- - [x] Updated the `Source code dataset` counter
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: SQLPL` subsection
- - - [x] Added the `AI2001 Category: Source Code: Squirrel` subsection
- [x] Updated the `Community` section
- - [x] Fixed a dropdown graphical bug (partially)
- [x] Updated the `Technical` section
- - [x] Fixed a dropdown graphical bug (partially)
- [x] Updated the `Sandbox` section
- - [x] Fixed a dropdown graphical bug (partially)
...
<details><summary><p lang="en"><b>Version 169 (2023, Saturday, November 25th at 07:10 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V169.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a fourth consective day_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: STAR` subsection
- - - [x] Added the `AI2001 Category: Source Code: Starlark` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 170 (2023, Sunday, November 26th at 09:15 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V170.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug, as I didn't have the time again today. Continuing for a fifth consective day_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: Stata` subsection
- - - [x] Added the `AI2001 Category: Source Code: StringTemplate` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 172 (2023, Tuesday, November 28th at 07:15 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V172.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug, as I didn't have the time again today. Continuing for a seventh consective day_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: SuperCollider` subsection
- - - [x] Added the `AI2001 Category: Source Code: SVG` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
> [View this version separately](/OldVersions/README/English/2/101-200/README_V173.md)
...
> [View this version separately](/OldVersions/README/English/2/101-200/README_V174.md)
...
<details><summary><p lang="en"><b>Version 175 (2023, Wednesday, December 13th at 06:00 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V175.md)

> **Note** _Coming back after a 12-13 day break. Continuing for 1 consecutive day. Formatting bug is still present_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: Terra` subsection
- - - [x] Added the `AI2001 Category: Source Code: Textile` subsection
- - - [x] Added the `AI2001 Category: Source Code: Thrift` subsection
- - - [x] Added the `AI2001 Category: Source Code: TLA` subsection
- - - [x] Added the `AI2001 Category: Source Code: TSQL` subsection
- - - [x] Added the `AI2001 Category: Source Code: Twig` subsection
- - - [x] Added the `AI2001 Category: Source Code: TXL` subsection
- - - [x] Added the `AI2001 Category: Source Code: Unity3DAsset` subsection
- - - [x] Added the `AI2001 Category: Source Code: UNIX-Assembly` subsection
- - - [x] Added the `AI2001 Category: Source Code: VBA` subsection
- - - [x] Added the `AI2001 Category: Source Code: VCL` subsection
- - - [x] Added the `AI2001 Category: Source Code: Verilog` subsection
- - - [x] Added the `AI2001 Category: Source Code: Verilog-AMS` subsection
- - - [x] Added the `AI2001 Category: Source Code: Verona` subsection
- - - [x] Added the `AI2001 Category: Source Code: Vim-Script` subsection
- - - [x] Added the `AI2001 Category: Source Code: Vim-Snippet` subsection
- - - [x] Added the `AI2001 Category: Source Code: Vue` subsection
- - - [x] Added the `AI2001 Category: Source Code: Vue.js` subsection
- - - [x] Added the `AI2001 Category: Source Code: WaveFront-Material` subsection
- - - [x] Added the `AI2001 Category: Source Code: WaveFront-Object` subsection
- - - [x] Added the `AI2001 Category: Source Code: WDL` subsection
- - - [x] Added the `AI2001 Category: Source Code: WebIDL` subsection
- - - [x] Added the `AI2001 Category: Source Code: WebVTT` subsection
- - - [x] Added the `AI2001 Category: Source Code: WikiText` subsection
- - - [x] Added the `AI2001 Category: Source Code: XBase` subsection
- - - [x] Added the `AI2001 Category: Source Code: XProc` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 177 (2023, Friday, December 15th at 10:44 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V177.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. I feel part of it was on GitHubs end, as it isn't as bad as it was 2 weeks ago. Continuing for a third consective day_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: XSLT` subsection
- - - [x] Added the `AI2001 Category: Source Code: YARA` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 178 (2023, Saturday, December 16th at 11:11 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V178.md)
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: FuzzyMarkupLanguage (FML)` subsection
- - - [x] Added the `AI2001 Category: Source Code: Tampio` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 179 (2023, Sunday, December 17th at 11:23 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V179.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a fifth consective day_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: Cairo` subsection
- - - [x] Added the `AI2001 Category: Source Code: Plankalkül` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 180 (2023, Monday, December 18th at 11:37 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V180.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a sixth consective day_
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: Whitespace` subsection
- - - [x] Added the `AI2001 Category: Source Code: Wisp` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 182 (2023, Thursday, December 21st at 04:20 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V182.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a 2nd consecutive day._
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: Mojo` subsection
- - - [x] Added the `AI2001 Category: Source Code: Triton (ClosedAI)` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 183 (2023, Friday, December 22nd at 05:22 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V183.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a 3rd consecutive day._
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: MQL4` subsection
- - - [x] Added the `AI2001 Category: Source Code: MQL5` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 184 (2023, Saturday, December 23rd at 07:20 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V184.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a 4th consecutive day._
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: CWEB` subsection
- - - [x] Added the `AI2001 Category: Source Code: CEB` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 185 (2023, Sunday, December 24th at 06:41 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V185.md)

> **Note** _Just a normal daily update, with no attempts to fix the formatting bug. Continuing for a 5th consecutive day._
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: Turing` subsection
- - - [x] Added the `AI2001 Category: Source Code: Noop` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 186 (2023, Wednesday, December 27th at 06:40 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V186.md)

> **Note** _Just a normal daily update today after a day of no activity (no new datasets to add) and a day skipped. Continuing for 1 consecutive day._
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: ARITH-MATIC` subsection
- - - [x] Added the `AI2001 Category: Source Code: CPL` subsection
- - - [x] Added the `AI2001 Category: Source Code: FLOW-MATIC` subsection
- - - [x] Added the `AI2001 Category: Source Code: Lobster` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 187 (2023, Friday, December 29th at 06:50 pm PST)</b></p></summary>
...
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Source Code` section
- - - [x] Added the `AI2001 Category: Source Code: asm.js` subsection
- - - [x] Added the `AI2001 Category: Source Code: Information Processing Language` subsection
- - - [x] Added the `AI2001 Category: Source Code: PLANNER` subsection
- - - [x] Added the `AI2001 Category: Source Code: POP-1` subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 197 (2024, Monday, January 29th at 06:32 pm PST)</b></p></summary>
...
> **Note** _I could have continued for a 4th consecutive day, but there were no AI2001 repositories planned for today, meaning there was nothing to work with. Continuing for 1 consecutive day_
...
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Piano` sub-subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Violin` sub-subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><p lang="en"><b>Version 199 (2024, Thursday, February 1st at 06:08 pm PST)</b></p></summary>

**This version was made by:** [`@seanpm2001`](https://github.com/seanpm2001/)

> [View this version separately](/OldVersions/README/English/2/101-200/README_V199.md)

<!-- Do not mention the bug any further outside of source code comments unless you try to fix it !-->
<!-- TODO https://github.com/seanpm2001/AI2001/issues/2 !-->

> **Note** _Couldn't make an update yesterday, as I had a really off day. Continuing for 1 consecutive day_

> Changes:

- [x] Updated the tags section
- - [x] Added a new line for the 4 most recent datasets
- [x] Updated the `Dataset counters` section
- - [x] Updated the `Audio dataset` counter
- [x] Updated the `Datasets` section
- - [x] Updated the `C: Audio` section
- - - [x] Updated the `AI2001 Category: Audio: Instruments` subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Trombone` sub-subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Trumpet` sub-subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Tuba` sub-subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Xylophone` sub-subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
- - [x] Updated other variables
- [x] Updated the `file history` section
- - [x] Added an entry for version 199
...
<details><summary><p lang="en"><b>Version 200 (2024, Friday, February 2nd at 11:20 pm PST)</b></p></summary>
...
> **Note** _This update almost didn't come at all, since I was so distracted today, and had less than an hour left to work. Continuing for a 2nd consecutive day_
...
- - [x] Updated the `C: Audio` section
- - - [x] Updated the `AI2001 Category: Audio: Instruments` subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Accordion` sub-subsection
- - - [- [x] Added the `AI2001 Category: Audio: Instruments S: Drums` sub-subsection
- [x] Updated the `file info` section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
- - [x] Updated other variables
- [x] Updated the `file history` section
- - [x] Added an entry for version 200
...
Functionality
Large datasets
Saving history from being rewritten (deepfake control system)
